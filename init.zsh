...
alias ${gprefix}cs='git show --stat --patch --pretty=format:"${_git_log_fuller_format}"'
...
alias ${gprefix}lc='git shortlog --summary --numbered --no-merges'
...
alias ${gprefix}sd='git stash show --stat --patch'
